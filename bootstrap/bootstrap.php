...
spl_autoload_register(function ($class)
{
	...
	$youtube_base_dir = __DIR__ . '/../youtubedownloader/src/';
	...
	// with .php
	$file = $youtube_base_dir . str_replace('\\', '/', $relative_class) . '.php';
...
$container = call_user_func_array(
	function($custom = 'custom')
	{
		...
		$config_dir = realpath(__DIR__) . $ds . '/../youtubedownloader/config' . $ds;
		...
		$cache = \YoutubeDownloader\Cache\FileCache::createFromDirectory(
			__DIR__ . DIRECTORY_SEPARATOR . '/../youtubedownloader/cache'
		);
