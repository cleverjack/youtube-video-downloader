...
--
-- Host: 127.0.0.1
-- Generation Time: Aug 14, 2017 at 09:55 PM
...
(30, '2017_08_07_140140_create_categories_table', 1),
(31, '2017_08_08_074515_create_videos_table', 1);
...
CREATE TABLE `videos` (
  ...
  `publish_at` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
